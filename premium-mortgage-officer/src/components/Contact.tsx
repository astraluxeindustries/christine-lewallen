            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:christinelewallenlvlender@gmail.com" className="text-lg font-semibold text-slate-900 hover:text-blue-700 transition-colors">
                    christinelewallenlvlender@gmail.com
                  </a>
                </div>
              </div>
